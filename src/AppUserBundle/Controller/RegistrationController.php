...
class RegistrationController extends Controller
{
    public function registerAction(Request $request)
    {
        ...
        if ($this->container->get('security.context')->isGranted('ROLE_PATIENT')) {
            return $this->redirect($this->generateUrl('patient_view_front'));                   
        } elseif ($this->container->get('security.context')->isGranted('ROLE_PHYSICIANS')) {            
            $user = $this->get('security.context')->getToken()->getUser();
            return $this->redirect($this->generateUrl('physicians_view_front', array("id" => $user->getId())));                                     
        } elseif ($this->container->get('security.context')->isGranted('ROLE_GUESS')) {
